...
function M.setup(programs)
  ...
  hl.bind(mainMod .. " + CTRL + H", hl.dsp.exec_cmd("kitty --class hyprchy-tui -e hyprchy-tui"))
  ...
  -- Hyprchy launcher stack: same bindings, Walker/Elephant where useful.
  ...
  hl.bind(mainMod .. " + Escape", hl.dsp.exec_cmd("~/.config/hypr/scripts/walker-window-switch.sh"))
