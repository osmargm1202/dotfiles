...
function M.setup(programs)
  ...
  hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("orgm-hypr obsidian open-or-focus"))
  hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("orgm-hypr zen open-new-window"))
  hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(program("smart_run", "orgm-hypr smart-run run")))
  ...
  hl.bind(mainMod .. " + ALT + Space", hl.dsp.exec_cmd(program("control_center", "orgm-hypr menu main")))
  hl.bind(mainMod .. " + CTRL + R", hl.dsp.layout("togglesplit"))
  hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("orgm-hypr file open --launcher fuzzel"))
  hl.bind(mainMod .. " + CTRL + M", hl.dsp.exec_cmd("orgm-hypr file open-dir --launcher fuzzel"))
  hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("orgm-hypr file open-terminal --launcher fuzzel"))
  hl.bind(mainMod .. " + Escape", hl.dsp.exec_cmd("orgm-hypr windows switch --launcher fuzzel"))
  hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("orgm-hypr tmux arch --launcher fuzzel"))
  hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("orgm-hypr calc fuzzel"))
  hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("orgm-hypr ssh host --launcher fuzzel"))
  ...
  hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("orgm-hypr wallpaper pick"))
  hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("orgm-hypr calendar toggle-ui"))
  ...
  -- Media keys.
  hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("orgm-hypr osd volume up"), { repeating = true, locked = true })
  hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("orgm-hypr osd volume down"), { repeating = true, locked = true })
  hl.bind("XF86AudioMute", hl.dsp.exec_cmd("orgm-hypr osd volume mute"), { locked = true })
  hl.bind("CTRL + XF86AudioRaiseVolume", hl.dsp.exec_cmd("orgm-hypr osd mic up"), { repeating = true })
  hl.bind("CTRL + XF86AudioLowerVolume", hl.dsp.exec_cmd("orgm-hypr osd mic down"), { repeating = true })
  hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("orgm-hypr osd mic mute"), { locked = true })
  hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
  hl.bind("XF86AudioStop", hl.dsp.exec_cmd("playerctl stop"), { locked = true })
  hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("playerctl previous"), { locked = true })
  hl.bind("XF86AudioNext", hl.dsp.exec_cmd("playerctl next"), { locked = true })
  hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("orgm-hypr osd brightness up"), { repeating = true, locked = true })
  hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("orgm-hypr osd brightness down"), { repeating = true, locked = true })
  ...
  hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd("orgm-hypr windows kill-menu"))
