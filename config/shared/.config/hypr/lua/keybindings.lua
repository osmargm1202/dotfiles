...
function M.setup(programs)
  ...
  hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(program("smart_run", "hypr-smart-run")))
  ...
  hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("fuzzel-open-file"))
  hl.bind(mainMod .. " + CTRL + M", hl.dsp.exec_cmd("fuzzel-open-file-dir"))
  hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("fuzzel-open-file-terminal"))
  hl.bind(mainMod .. " + Escape", hl.dsp.exec_cmd("fuzzel-hypr-window"))
  hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("fuzzel-tmux-arch"))
  hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("fuzzel-calc"))
  hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("fuzzel-ssh-host"))
