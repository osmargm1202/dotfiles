...
function M.setup(programs)
  ...
  hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("~/.local/bin/hypr-zen-new-window"))
  hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(program("smart_run", "~/.local/bin/hypr-smart-run")))
  ...
  hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("~/.local/bin/hypr-random-wallpaper pick"))
  ...
  hl.bind("CTRL + XF86AudioRaiseVolume", hl.dsp.exec_cmd("~/.local/bin/mic-volume-osd up"), { repeating = true })
  hl.bind("CTRL + XF86AudioLowerVolume", hl.dsp.exec_cmd("~/.local/bin/mic-volume-osd down"), { repeating = true })
